...
data_er <- filter(data, er_status_by_ihc %in% c("Positive","Negative")) %>% 
  rename(er_status_by_ihc = "ER_Status") %>% 
...
# Calculate metrics
accuracy(results, truth = ER_Status, estimate = .pred_class)
precision(results, truth = ER_Status, estimate = .pred_class)
recall(results, truth = ER_Status, estimate = .pred_class)
f_meas(results, truth = ER_Status, estimate = .pred_class)
